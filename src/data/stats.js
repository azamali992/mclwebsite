...
const STATS = {
  ...
  employees: { value: '500+', label: 'Dedicated', subtitle: 'Employees', group: 'company', order: 6 },
  satisfied_clients: { value: '1000+', label: 'Satisfied', subtitle: 'Clients', group: 'company', order: 7 },
