  ...
  return (
    <div className="flex items-center space-x-4 pt-4 sm:pt-0 xl:px-4 first:pl-0 border-t-0 group">
      ...
      <div className="flex flex-col">
        <span className="text-[11px] font-bold text-gray-900 tracking-wide leading-tight">
          {title}
        </span>
...
export default function MgpsSolutions() {
  ...
  const bottomFeatures = [
    { icon: <FaAward className="text-xl" />, title: "International Standards", desc: "HTM 02 / NFPA 99" },
    { icon: <FaTools className="text-xl" />, title: "Turnkey Projects", desc: "End-to-End Solutions" },
    { icon: <FaHeadset className="text-xl" />, title: "24/7 Support", desc: "Maintenance & Service" },
    { icon: <FaUserTie className="text-xl" />, title: "Trained Engineers", desc: "Expert Workforce" }
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-8 xl:gap-16 items-start">
          ...
          >
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              We provide end-to-end Medical Gas Pipeline Systems (MGPS) designed to international standards (HTM 02-01, NFPA 99, ISO 7396-1) ensuring safety, efficiency and reliability.
            </p>

            <ul className="space-y-3">
              {checkItems.map((item, index) => (
                <li key={index} className="flex items-start group">
                  <span className="mt-1 mr-3 text-mclRed text-sm transition-transform duration-300 group-hover:scale-110">
                    <FaCheck />
                  </span>
          ...
          >
            ...
            <div className="relative w-full flex justify-center lg:justify-end mb-8 mt-4 lg:mt-0 h-[400px] sm:h-[500px] lg:h-[650px]">
              <div className="relative w-full h-full flex justify-center lg:justify-end">
                <img 
                  src={renderImg} 
                  alt="3D Medical Gas Pipeline Layout" 
                  className="w-full h-full object-contain mix-blend-darken transform scale-125 xl:scale-150 lg:-translate-x-8 relative z-10 pointer-events-none hover:scale-135 xl:hover:scale-[1.6] transition-transform duration-700"
                />
              </div>
